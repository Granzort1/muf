...
# 그래프 타이틀 수동 설정
custom_titles = {
    "Gasan A1 Tower Parking Lot": "Correlation Analysis: Indoor Parking Lot",
    "A-Shop Screen Golf": "Correlation Analysis: Indoor Sports Facility",
    "Yeongtong Station": "Correlation Analysis: Station",
    "Eden Daycare": "Correlation Analysis: Children's Facility",
...
def process_data():
    ...
    facility_name = "Good Neighbor Daycare Center"
    ...
    facility_name = "Yeongtong Station"
