...
def graph_ga(ob1_min, title_name):
...
def graph_na(ob1_min, title_name):
    # Convert tmfc_d and tmfc_h to datetime format
    ob1_min['datetime'] = pd.to_datetime(ob1_min['tmfc_d'].astype(str) + ob1_min['tmfc_h'].astype(str).str.zfill(2), format='%Y%m%d%H')
    ob1_min['log_pm10'] = np.log(ob1_min['pm10'])
...
def graph_da(ob1_min, title_name):
    # Convert tmfc_d and tmfc_h to datetime format
    ob1_min['datetime'] = pd.to_datetime(ob1_min['tmfc_d'].astype(str) + ob1_min['tmfc_h'].astype(str).str.zfill(2), format='%Y%m%d%H')
    ob1_min['log_pm10'] = np.log(ob1_min['pm10'])
...
def graph_ra(ob1_min, title_name):
    # Convert tmfc_d and tmfc_h to datetime format
    ob1_min['datetime'] = pd.to_datetime(ob1_min['tmfc_d'].astype(str) + ob1_min['tmfc_h'].astype(str).str.zfill(2), format='%Y%m%d%H')
    ob1_min['log_pm10'] = np.log(ob1_min['pm10'])
...
graph_da(ob1_min, "(가산A1타워주차장)")
graph_ra(ob2_min, "(에이샵스크린골프)")
graph_ga(ob3_min, "(영통역대합실)")
graph_ga(ob4_min, "(영통역지하역사)")
graph_na(ob5_min, "(이든어린이집)")
graph_na(ob6_min, "(좋은이웃데이케어센터1)")
graph_na(ob7_min, "(좋은이웃데이케어센터2)")
graph_na(ob8_min, "(좋은이웃데이케어센터3)")
graph_na(ob9_min, "(좋은이웃데이케어센터4)")
graph_ga(ob10_min, "(하이씨앤씨학원)")
